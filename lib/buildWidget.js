		...
		result.forEach(function(resultItem){
			...
			if (dirExists){
				...
				files.forEach(function(item){
					 ...
					 * @build widget css
					 */
					if ($.is.css(item) && !filesListObj[staticUrl] && buildCssTag && item == widgetName+$.is.cssSuffix ){
					 ...
					 * @build widget js
					 */
					if ($.is.js(item) && !filesListObj[staticUrl] && buildJsTag && item == widgetName+$.is.jsSuffix){
