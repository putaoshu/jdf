...
jdf.help = function(){
    ...
    content = content.concat([
        ...
        '  Commands:',
        '',
	  '     install		download init dir ,demo, external module',		
	  //'    init		project directory init',
        '    build		build project',
        '    release		release project',
        '    output		output project',
        '    output   -d	output project ( include html folder) ',
        '    output   file	output your own definition file',
        '    upload		upload output files to remote sever',
        '    upload   -d	upload output project ( include html folder) ',
        '    upload   file	upload output your own definition file',
        '    upload   -custom localdir serverdir',
        '    widget   -preview file  preview local widget',
      //'    u   -w	watch upload output files to remote sever',
		' ',
		'  Extra commands:',
        '',
		'    compress		compress js&&css (jdf c input output)',
